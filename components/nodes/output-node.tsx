  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden min-w-[180px] sm:min-w-[220px]">
      ...
      <div className="px-4 sm:px-6 pb-4 sm:pb-6 text-center">
        <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">{data.label || "Output"}</h3>
        <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">{data.description || "Data output node"}</p>
