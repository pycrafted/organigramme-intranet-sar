  ...
  return (
    ...
    >
      ...
      <div className="px-6 pb-6 text-center">
        <h3 className="text-base font-semibold text-gray-900 mb-1">{data.label || "Process"}</h3>
        <p className="text-sm text-gray-500 leading-relaxed">{data.description || "Data processing node"}</p>
